...
func Build() *cmdr.Commander {
	return cmdr.MakeCommander().
		...
		With(odemcli.WorkerAction(odemcli.WorkerWithTiming("build", release.LocalBuild))).
		Subcommanders(
			cmdr.MakeCommander().
			...
			cmdr.MakeCommander().
				...
				With(odemcli.WorkerAction(odemcli.WorkerWithTiming("build-all", release.BuildArtifacts))),
			cmdr.MakeCommander().
				SetName("update").
